...
namespace EiraPlaza.Areas.Customer.Controllers
{
    [Area("Customer")]
    public class CartController : Controller
    {
       ...
       public IActionResult AddCoupon()
        ...
        public async Task<IActionResult> SummaryPost( string stripeToken)
        {
            ...
            detailCart.listCart = await _db.ShoppingCart.Where(u => u.ApplicationUserId == claim.Value).ToListAsync();
            ...
            {
                await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == claim.Value).FirstOrDefault().Email, "Eira Plaza order Created" + detailCart.OrderHeader.Id.ToString(), "Order has been addedsuccessufully");
